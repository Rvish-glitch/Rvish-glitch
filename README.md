# Hey, I'm Anush 👋
I'm a Python backend developer, and I spend most of my time building systems where reliability actually matters — clean APIs, optimized databases, and backends that don't break in production.

## Main interests
- REST API design and performance optimization
- Backend architecture with Django and FastAPI
...
On the side — Competitive programmer as CF Specialist (1403), Meta Hacker Cup R2.
